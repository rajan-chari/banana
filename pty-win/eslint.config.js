...
export default tseslint.config(
  ...
  // Universal curated rules. These are the actual "earn their keep" picks.
  {
    ...
    rules: {
      ...
      // Current top offenders: initSettingsModal 89, createWsRuntime 85,
      // registerInspectionRoutes 78, showQuickMessageInput ~76
      ...
      "max-lines-per-function": [
        "error",
        { max: 89, skipBlankLines: true, skipComments: true, IIFEs: false },
      ],
