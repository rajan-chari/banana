...
## Current Focus
Pipeline complete. Waiting for pty-win restart to go live. Monitoring for next task.
...
- ONNX output_probability is dict-keyed (not index-based): result['output_probability'].data[0]['busy']
